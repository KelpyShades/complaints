...
/// Mobile admin activity — card style aligned with student activity feed.
class MobileAdminActivityScreen extends ConsumerStatefulWidget {
  const MobileAdminActivityScreen({super.key});

  @override
  ConsumerState<MobileAdminActivityScreen> createState() =>
      _MobileAdminActivityScreenState();
}

class _MobileAdminActivityScreenState
    extends ConsumerState<MobileAdminActivityScreen> {
  @override
                ...
                data: (activities) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _MobileAdminActivityCard(
                        activity: activity,
...
class _MobileAdminActivityCard extends StatelessWidget {
  const _MobileAdminActivityCard({
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () => context.go(
            AppRoutes.adminComplaintDetailPath(activity.complaintId),
          ),
          borderRadius: BorderRadius.circular(12),
          child: Padding(
