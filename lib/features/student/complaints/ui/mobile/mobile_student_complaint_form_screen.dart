...
class MobileStudentComplaintFormScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<MobileStudentComplaintFormScreen> createState() =>
      _MobileStudentComplaintFormScreenState();
}

class _MobileStudentComplaintFormScreenState
    extends ConsumerState<MobileStudentComplaintFormScreen> {
        ...
        child: Center(
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Text('What do you need help with?', style: theme.textTheme.h4),
                ...
                ShadInputFormField(
                  ...
                  placeholder: const Text('e.g. Broken projector in Room 101'),
                ...
                ShadInputFormField(
                  ...
                  placeholder: const Text('Describe the issue in detail...'),
                  maxLines: 5,
